...
class FTPClient:
    ...
    def verify_local_file_with_remote_hash(self, local_path: str, remote_path: str, algorithm: str = ...) -> None: ...
...
class AsyncFTPClient:
    ...
    async def verify_local_file_with_remote_hash(self, local_path: str, remote_path: str, algorithm: str = ...) -> None: ...
