...
FTP_VERIFY_STATUS_NONE = 0
FTP_VERIFY_STATUS_PASSED = 1
FTP_VERIFY_STATUS_FAILED = 2
FTP_VERIFY_STATUS_UNAVAILABLE = 3
FTP_VERIFY_SOURCE_LOCAL = 0x0001
FTP_VERIFY_SOURCE_REMOTE = 0x0002
FTP_VERIFY_POLICY_NONE = 0
FTP_VERIFY_POLICY_LOCAL_EXPECTED = 1
FTP_VERIFY_POLICY_REMOTE_OPTIONAL = 2
FTP_VERIFY_POLICY_REMOTE_REQUIRED = 3
FTP_VERIFY_POLICY_LOCAL_AND_REMOTE = 4
FTP_RETRY_CATEGORY_NETWORK = 0x0001
FTP_RETRY_CATEGORY_SERVER = 0x0002
FTP_RETRY_CATEGORY_AMBIGUOUS = 0x0004
FTP_RETRY_CATEGORY_AUTH = 0x0008
FTP_RETRY_CATEGORY_PROTOCOL = 0x0010
FTP_RETRY_CATEGORY_LOCAL = 0x0020
FTP_RETRY_CATEGORY_DEFAULT = 0x0007
